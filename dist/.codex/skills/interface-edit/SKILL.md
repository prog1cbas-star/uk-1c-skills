...
```powershell
powershell.exe -NoProfile -File '.codex/skills/interface-edit/scripts/interface-edit.ps1' -CIPath '<path>' -Operation hide -Value '<cmd>'
```

### JSON mode

```powershell
powershell.exe -NoProfile -File '.codex/skills/interface-edit/scripts/interface-edit.ps1' -CIPath '<path>' -DefinitionFile '<json>'
```
