...
```powershell
powershell.exe -NoProfile -File .codex/skills/web-stop/scripts/web-stop.ps1 <параметры>
```
...
```powershell
# Остановить Apache
powershell.exe -NoProfile -File .codex/skills/web-stop/scripts/web-stop.ps1

# С указанием пути
powershell.exe -NoProfile -File .codex/skills/web-stop/scripts/web-stop.ps1 -ApachePath "C:\tools\apache24"
```
